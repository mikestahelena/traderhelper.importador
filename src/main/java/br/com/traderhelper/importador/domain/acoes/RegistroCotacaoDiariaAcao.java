...
public class RegistroCotacaoDiariaAcao {
	...
	public String toString() {
		return new ToStringBuilder(this).append("\nTIPREG", TIPREG).append("\nDATAPG", DATAPG)
				.append("\nCODBDI", CODBDI).append("\nCODNEG", CODNEG).append("\nTPMERC", TPMERC)
				.append("\nNOMRES", NOMRES).append("\nESPECI", ESPECI).append("\nPRAZOT", PRAZOT)
				.append("\nMODREF", MODREF).append("\nPREABE", PREABE).append("\nPREMAX", PREMAX)
				.append("\nPREMIN", PREMIN).append("\nPREMED", PREMED).append("\nPREULT", PREULT)
				.append("\nPREOFC", PREOFC).append("\nPREOFV", PREOFV).append("\nTOTNEG", TOTNEG)
				.append("\nQUATOT", QUATOT).append("\nVOLTOT", VOLTOT).append("\nPREEXE", PREEXE)
				.append("\nINDOPC", INDOPC).append("\nDATVEN", DATVEN).append("\nFATCOT", FATCOT)
				.append("\nPTOEXE", PTOEXE).append("\nCODISI", CODISI).append("\nDISMES", DISMES).toString();
	}
