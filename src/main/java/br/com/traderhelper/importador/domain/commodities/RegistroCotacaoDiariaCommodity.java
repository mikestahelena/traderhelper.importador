...
public class RegistroCotacaoDiariaCommodity {
    ...
    public String toString() {
        return new ToStringBuilder(this)
                .append("CODECO", CODECO)
                .append("NAMECO", NAMECO)
                .append("SETORC", SETORC)
                .append("DATECT", DATECT)
                .append("PRICEC", PRICEC)
                .append("OPENVL", OPENVL)
                .append("HIGHVL", HIGHVL)
                .append("LOWVLE", LOWVLE)
                .toString();
    }
