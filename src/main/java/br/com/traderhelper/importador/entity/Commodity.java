...
public class Commodity implements Serializable {
    ...
    public String toString() {
        return new ToStringBuilder(this)
                .append("id", id)
                .append("nomeCommodity", nomeCommodity)
                .append("codigoCommodity", codigoCommodity)
                .append("setorCommodity", setorCommodity)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, commodity.id) &&
                Objects.equals(nomeCommodity, commodity.nomeCommodity) &&
