...
public class Acao implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		Acao acao = (Acao) o;
		return Objects.equals(id, acao.id) && Objects.equals(codigoPapel, acao.codigoPapel);
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", id).append("codigoPapel", codigoPapel)
				.append("nomeResumidoPapel", nomeResumidoPapel).append("codigoBdi", codigoBdi)
				.append("codigoTipoMercado", codigoTipoMercado)
				.append("codigoEspecificacaoPapel", codigoEspecificacaoPapel)
				.append("indicadorCorrecao", indicadorCorrecao).append("codigoIsin", codigoIsin)
				.append("numeroDistribuicaoPapel", numeroDistribuicaoPapel).append("cotacoes", cotacoes).toString();
	}
}
