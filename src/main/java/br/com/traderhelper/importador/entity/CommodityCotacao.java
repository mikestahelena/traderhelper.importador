...
public class CommodityCotacao implements Serializable {
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", id).append("commodity", commodity)
				.append("dataCotacao", dataCotacao).append("precoFechamento", precoFechamento)
				.append("precoAbertura", precoAbertura).append("precoMaximo", precoMaximo)
				.append("precoMinimo", precoMinimo).toString();
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(id, that.id) && Objects.equals(commodity, that.commodity)
				&& Objects.equals(dataCotacao, that.dataCotacao)
				&& Objects.equals(precoFechamento, that.precoFechamento)
				&& Objects.equals(precoAbertura, that.precoAbertura) && Objects.equals(precoMaximo, that.precoMaximo)
